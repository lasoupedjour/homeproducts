...
<table align='center' border='0' cellpadding='0' cellspacing='0' width='600' style='border: 1px solid #cccccc; border-collapse: collapse; padding: 0px; width: 600px; margin: 0 auto;' class='breacktable'>
  ...
  <tr>
    <td bgcolor='#98c24d' style='font-family: Arial Narrow, Helvetica, arial, Verdana, sans-serif; font-size: 26px; color: #303e89;' colspan='3'>
      <img src='http://apps.pautacreativatemporales.com.mx/lamoderna/sauris/mailing/img/saurismail_03.jpg' width='600' height='260' border='0' alt='�nete al Club Sauris y ganar�s incre�bles premios' style='display:block;' class='fullimage' />
    </td>
  </tr>
  <tr>
    <td bgcolor='#519305' style='font-family: Arial Narrow, Helvetica, arial, Verdana, sans-serif; font-size: 26px; color: #303e89;' colspan='3'>
      <img src='http://apps.pautacreativatemporales.com.mx/lamoderna/sauris/mailing/img/saurismail_04.jpg' width='600' height='160' border='0' alt='Confirmaci�n' style='display:block;' class='fullimage' />
    </td>
  </tr>
  <tr>
    <td bgcolor='#519305' style='font-family: Arial Narrow, Helvetica, arial, Verdana, sans-serif; font-size: 26px; color: #303e89;'>
      <img src='http://apps.pautacreativatemporales.com.mx/lamoderna/sauris/mailing/img/saurismail_05.jpg' width='108' height='187' border='0' alt='Confirmaci�n' style='display:block;' class='fullimage' />
    </td>
    <td bgcolor='#937A5C' width='390' height='187' style='font-family: Arial Narrow, Helvetica, arial, Verdana, sans-serif; font-size: 26px; color: #FFFFFF; width: 390px; height: 187px;'>
        ...
        �Tu registro se realiz� con �xito!
        </font></p>
        ...
        <br>
        <strong><span style='color: #3c2400;'>N�mero de participante:</span></strong> $id_participantes<br>
        <strong><span style='color: #3c2400;'>Contrase�a:</span></strong> $pwd
        </font>
        ...
        Recuerda que entre m�s <strong>c�digos Sauris</strong> registres, m�s posibilidades tienes de ganar.
        </font></p>
    </td>
    <td bgcolor='#519305' style='font-family: Arial Narrow, Helvetica, arial, Verdana, sans-serif; font-size: 26px; color: #303e89;'>
      <img src='http://apps.pautacreativatemporales.com.mx/lamoderna/sauris/mailing/img/saurismail_07.jpg' width='102' height='187' border='0' alt='Confirmaci�n' style='display:block;' class='fullimage' />
    </td>
  </tr>
  <tr>
    <td bgcolor='#519305' style='font-family: Arial Narrow, Helvetica, arial, Verdana, sans-serif; font-size: 26px; color: #303e89;' colspan='3'>
      <img src='http://apps.pautacreativatemporales.com.mx/lamoderna/sauris/mailing/img/saurismail_08.jpg' width='600' height='128' border='0' alt='Confirmaci�n' style='display:block;' class='fullimage' />
    </td>
  </tr>
  <tr>
    <td bgcolor='#1d5029' width='600' height='60' style='font-family: Arial Narrow, Helvetica, arial, Verdana, sans-serif; font-size: 16; color: #f5e837; width: 600px; height: 60px;' colspan='3'>
		...
		if($mail->Send()){
            ...
            $resultado['res'] = 'error de env�o';
        }

    } catch (phpmailerException $e) {
        //echo $e->errorMessage();
        //echo "Error en el env�o, por favor intenta de nuevo.";
