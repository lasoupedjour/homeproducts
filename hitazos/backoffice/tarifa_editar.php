...
if($_POST["postback"]=="1"){
  ...
  $q = mysql_query("
  update tarifas set
  IDGrupoTarifa='$idgrupotarifa', TipoTarifa='$tipotarifa', TipoServicio='$tiposervicio',
  SubtipoServicio='$subtiposervicio', Valor='$valor', Impuesto='$impuesto',
  TarifaMensual='$tarifamensual', ImpuestoTarifaMensual='$impuestotarifamensual', NecesitaAutorizacion='$necesitaautorizacion'
  where id = $id_tarifa
  ") or die(mysql_error());
   ...
   <form class="form-floating ng-pristine ng-invalid ng-invalid-required ng-valid-email ng-valid-url ng-valid-pattern" action="tarifa_editar.php" method="POST">
     <fieldset>
       ...
       <div class="form-group">
         ...
         <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" id="subtiposervicio" name="subtiposervicio" ng-model="model.subtiposervicio" value="<?= $subtiposervicio ?>" required="">
       </div>
       <div class="form-group">
         <label class="control-label">Valor</label>
         <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" id="valor" name="valor" ng-model="model.valor" value="<?= $valor ?>" required="">
       </div>
       <div class="form-group">
         <label class="control-label">Impuesto</label>
         <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" id="impuesto" name="impuesto" ng-model="model.impuesto" value="<?= $impuesto ?>" required="">
       </div>
       <div class="form-group">
         <label class="control-label">Tarifa Mensual</label>
         <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" id="tarifamensual" name="tarifamensual" ng-model="model.tarifamensual" value="<?= $tarifamensual ?>" required="">
       </div>
       <div class="form-group">
         <label class="control-label">Impuesto Tarifa Mensual</label>
         <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" id="impuestotarifamensual" name="impuestotarifamensual" ng-model="model.impuestotarifamensual" value="<?= $impuestotarifamensual ?>" required="">
       </div>
       <div class="form-group">
         <label class="control-label">¿Necesita Autorización?</label>
         <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" id="necesitaautorizacion" name="necesitaautorizacion" ng-model="model.necesitaautorizacion" value="<?= $necesitaautorizacion ?>" required="">
       </div>
       <div class="form-group">
