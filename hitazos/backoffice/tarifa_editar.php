...
if($_POST["postback"]=="1"){
  ...
  $q = mysql_query("
  update tarifas set
  IDGrupoTarifa='$idgrupotarifa', TipoTarifa='$tipotarifa', TipoServicio='" . utf8_decode($tiposervicio) . "',
  SubtipoServicio='" . utf8_decode($subtiposervicio) . "', Valor='$valor', Impuesto='$impuesto',
