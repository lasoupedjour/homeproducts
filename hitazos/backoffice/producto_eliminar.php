...
if($_POST["postback"]){
  ...
  echo("<script>alert('Registro eliminado'); window.location.href='productos.php';</script>");
}else{
  $id_producto = $_GET["id"];
  if($id_producto==""){
   ...
   <form class="form-floating ng-pristine ng-invalid ng-invalid-required ng-valid-email ng-valid-url ng-valid-pattern" action="producto_eliminar.php" method="POST">
     <fieldset>
       <div class="form-group">
         ...
         <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" id="sap" name="sap" ng-model="model.sap" value="<?= $sap ?>" readonly>
       </div>
       <div class="form-group">
         <label class="control-label">Categoría</label>
         <select class="form-control1 ng-invalid ng-invalid-required" id="categoria" name="categoria" ng-model="model.categoria" readonly><option value="? undefined:undefined ?"></option>
       ...
       <div class="form-group">
         ...
         <select class="form-control1 ng-invalid ng-invalid-required" id="subcategoria" name="subcategoria" ng-model="model.subcategoria" readonly><option value="? undefined:undefined ?"></option>
       ...
       <div class="form-group">
         ...
         <select class="form-control1 ng-invalid ng-invalid-required" id="tipotarifa" name="tipotarifa" ng-model="model.tipotarifa" readonly><option value="? undefined:undefined ?"></option>
       ...
       <div class="form-group">
         ...
         <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" id="modelo" name="modelo" ng-model="model.modelo" value="<?= $modelo ?>" readonly>
       </div>
       <div class="form-group">
