...
@Component({
    selector: 'nuevasrefacciones',
    templateUrl: './nuevas-refacciones.component.html'
})

export class NuevasRefaccionesComponent {
    title = 'app';
    ...
    nuevasRefacciones() {
        ...
        this.subscription = this._httpService.postJSON(params, 'administracion/nuevas-refacciones.php')
            .subscribe(
            data => {
                console.log('data');
                console.log(data);
