...
@Component({
    selector: 'nuevoscambiosfisicosdist',
    templateUrl: './nuevos-cambios-fisicos-dist.component.html'
})

export class NuevosCambiosFisicosDistComponent {
    title = 'app';
    ...
    nuevosCambiosFisicosDist() {
        ...
        this.subscription = this._httpService.postJSON(params, 'administracion/nuevos-cambios-fisicos-distribuidor.php')
            .subscribe(
            data => {
                console.log('data');
                console.log(data);
