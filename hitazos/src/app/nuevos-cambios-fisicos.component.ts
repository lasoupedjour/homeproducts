...
@Component({
    selector: 'nuevoscambiosfisicos',
    templateUrl: './nuevos-cambios-fisicos.component.html'
})

export class NuevosCambiosFisicosComponent {
    title = 'app';
    ...
    nuevosCambiosFisicos() {
        ...
        this.subscription = this._httpService.postJSON(params, 'administracion/nuevos-cambios-fisicos.php')
            .subscribe(
            data => {
                console.log('data');
                console.log(data);
