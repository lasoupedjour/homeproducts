...
@Component({
    selector: 'nuevascotizaciones',
    templateUrl: './nuevas-cotizaciones.component.html'
})

export class NuevasCotizacionesComponent {
    title = 'app';
    ...
    nuevasRefacciones() {
        ...
        this.subscription = this._httpService.postJSON(params, 'administracion/nuevas-cotizaciones.php')
            .subscribe(
            data => {
                console.log('data');
                console.log(data);
